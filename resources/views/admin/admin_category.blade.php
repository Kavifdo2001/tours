                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-icons">
                                                        <a href="{{ route('admin.subcategory', $category->id) }}"
                                                            class="text-primary">
                                                            <span class="btn btn-primary"><i class="fas fa-plus"></i>
                                                                <span>Subcategory</span></span>
                                                        </a>
                                                        <a href="{{ route('edit.category', $category->id) }}"
                                                            class="text-warning">
                                                            <span class="btn btn-warning"><i class="fas fa-edit"></i>
                                                                <span>Edit</span></span>
                                                        </a>
                                                        <a href="{{ route('delete.category', $category->id) }}"
                                                            class="text-danger" onclick="confirmDelete(event)">

...
<head>
    ...
    <title> Travel System | Dashboard </title>
...
<script>
    function confirmDelete(event) {
        ...
        var urlToRedirect = event.currentTarget.getAttribute('href'); // Get the href of the clicked link
        console.log(urlToRedirect); // Log the URL to console
        if(confirm("Are you sure you want to delete this item?")) {
            window.location.href = urlToRedirect; // Redirect to the URL if confirmed
        }
    }
</script>
